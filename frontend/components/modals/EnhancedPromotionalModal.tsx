...
interface EnhancedPromotionalModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
  heading?: string;
  ...
  ctaText?: string;
  guestText?: string;
  primaryGradient?: string; // e.g., "from-blue-600 to-indigo-600"
}

export default function EnhancedPromotionalModal({
  isOpen,
  onClose,
  onSuccess,
  heading = "Start Your Learning Journey Today",
  subheading = "Join thousands of students learning with us",
  imageUrl,
  imageAlt = "Education",
  ctaText = "Get Started",
  guestText = "No thanks, continue browsing",
  primaryGradient = "from-blue-600 to-indigo-600",
}: EnhancedPromotionalModalProps) {
          ...
          >
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_1.1fr] min-h-[500px] md:min-h-[550px]">
                {/* Left Side - Image */}
                <div className="hidden md:flex relative overflow-hidden bg-gradient-to-br from-blue-400 via-blue-300 to-indigo-400 items-center justify-center p-8">
                  ...
                  <div className="relative z-10 w-full h-full">
                    {imageUrl ? (
                      ...
                      <div className="flex flex-col items-center justify-center h-full w-full">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2 mt-4">Learn Together</h3>
                ...
                <div className="relative p-6 sm:p-8 md:p-10 flex flex-col justify-between bg-white">
                  ...
                  <div className="flex-1">
                    {/* Mobile Image */}
                    {imageUrl && (
                      <div className="md:hidden mb-6 -mx-6 sm:-mx-8 px-6 sm:px-8 pt-6 sm:pt-8 pb-4 bg-gradient-to-br from-blue-400 via-blue-300 to-indigo-400 rounded-b-2xl relative h-40">
                        <Image
                          src={imageUrl}
                          alt={imageAlt}
                          fill
                    ...
                    <div className="mb-4 sm:mb-6">
                      ...
                      <p className="text-sm sm:text-base text-gray-600">{subheading}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className={`w-full mt-6 px-6 py-2.5 sm:py-3 bg-gradient-to-r ${primaryGradient} hover:opacity-90 disabled:opacity-50 text-white font-semibold rounded-xl transition-all duration-200 flex items-center justify-center gap-2 group`}
                      >
                        {loading ? (
                          <>
